...
<div class="dash_container">
    ...
    <section class="main-section mar-30">
        <div class="row">
            <div class="col-4 msgs-3-col-item">
                <sup><i class="fal fa-question-circle" style="font-size:12px;"
                        title="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi est eaque laborum eum sit? Ipsa earum dolor velit non praesentium architecto hic cupiditate fugiat sed. Maiores quod repellendus aliquam commodi."></i></sup>
    ...
    <section class="offices-msgs">
        <div class="alerts-notif" style="width:66.66%;">
            <div class="alert-content">
                <div class="content-head">
                    <h2>Recent Activity <sup><i class="fal fa-question-circle" style="font-size:12px;"
                                title="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi est eaque laborum eum sit? Ipsa earum dolor velit non praesentium architecto hic cupiditate fugiat sed. Maiores quod repellendus aliquam commodi."></i></sup>
                    </h2>
                </div>
        ...
        <div class="alerts-notif">
            <div class="alert-content">
                <div class="content-head">
                    <h2>Transit Activity <sup><i class="fal fa-question-circle" style="font-size:12px;"
                                title="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi est eaque laborum eum sit? Ipsa earum dolor velit non praesentium architecto hic cupiditate fugiat sed. Maiores quod repellendus aliquam commodi."></i></sup>
                    </h2>
                </div>
                <div id="log">
                    <ul id="content-log-list" class="mCustomScrollbar content fluid light" data-mcs-theme="inset-2-dark"
