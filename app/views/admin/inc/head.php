...
<head>
    ...
    <script>
    var socket = io.connect('http://192.168.43.11:3001');
    $(function() {
        $("#accordion").accordion();
...
<body style="position:relative;">
    ...
    <div class="confirmationModal" style="display:none;">
        <div class="confirmationMessage">
            <h2></h2>
            <div class="mapCon mCustomScrollbar content fluid light" data-mcs-theme="inset-2-dark"
                ...
                <div id="placeForm" style="display:none;">
                        ...
                        <div class="form-group">
                            <select style="width: 100%;border-radius:35px;" name="from" id="placeTerminal">
                                <optgroup>
                                    ...
                                    <option value="<?=$terminal->latlong?>" data-id="<?=$terminal->id?>">
                    ...
                    <div class="changepass-holder">
                        <div class="form-group">
                            <input type="file" id="placeImageData" value="" name="placeImg"
                                style="width: 100%;border-radius:35px;">
                            <label for="placeImg">Photo</label>
                        </div>
                        <div class="form-group">
                            <input type="text" id="placeName" value="" name="placeN"
                                style="width: 100%;border-radius:35px;">
                            <label for="placeN">Name of place</label>
                        </div>
                        <div class="form-group">
                            <input type="text" id="placeAdd" value="" name="address"
                                style="width: 100%;border-radius:35px;">
                ...
                <div id="busForm" style="display:none;">
                    ...
                    <div class="changepass-holder">
                        <div class="form-group">
                            <input type="text" id="busNum" value="" name="busNum"
                                style="width: 100%;border-radius:35px;">
                ...
                <div id="driverForm" style="display:none;">
                    <div class="changepass-holder">
                        <div class="form-group">
                            <input type="text" id="driverN" value="" name="driverName"
                                style="width: 100%;border-radius:35px;">
                            <label for="driverName">Driver's Name</label>
                        </div>
                        <div class="form-group">
                            <input type="text" id="driverCon" value="" name="contact"
                                style="width: 100%;border-radius:35px;">
                ...
                <div id="dispatcherForm" style="display:none;">
                    ...
                    <div class="changepass-holder">
                        <div class="form-group">
                            <input type="text" id="disPatch" value="" name="dispatcherName"
                                style="width: 100%;border-radius:35px;">
                            <label for="dispatcherName">Dispathcer Name</label>
                        </div>
                        <div class="form-group">
                            <input type="text" id="disContact" value="" name="contact"
                                style="width: 100%;border-radius:35px;">
                            <label for="contact">Contact</label>
                        </div>
                    </div>
                ...
                <div id="routeForm" style="display:none;">
                    <div class="changepass-holder">
                        <div class="form-group">
                            <input type="text" value="" id="routeNames" name="routeNameN"
                                style="width: 100%;border-radius:35px;">
                ...
                <div id="termAddForm">
                    <div class="changepass-holder termFC">
                        <div class="form-group">
                            <input type="text" value="" id="nameTerm" name="nameTerminal"
                                style="width: 100%;border-radius:35px;">
                ...
                <div class="actionButtonModal">
                    ...
                    <button id="cancelDeletion">Cancel <sup><i class="fal fa-question-circle" style="font-size:12px;"
                                title="Separate driver from bus because it could happen that the company has a spare busses."></i></sup></button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div id="navigation-scroll" class="mCustomScrollbar content fluid light" data-mcs-theme="inset-2-dark"
                    ...
                    <nav>
                        ...
                        <ul id="menus-nav" style="margin-bottom:20px;">
                            ...
                            <li data-link="<?=URL_ROOT;?>/admin/schedule"
                                class="<?=($_SESSION['menu_active']=="schedule") ? 'menu-active' : ''; ?>">
                                <i class="fal fa-calendar-week"></i>
                                <a href="#"> Schedules</a>
                            </li>
                            <li data-link="<?=URL_ROOT;?>/admin/messenger"
                                class="<?=($_SESSION['menu_active']=="messages") ? 'menu-active' : ''; ?>">
                                <i class="fal fa-envelope"></i>
                                <a href="#"> Chat</a>
                            </li>
                            <li data-link="<?=URL_ROOT;?>/admin/driver"
                                class="<?=($_SESSION['menu_active']=="driver") ? 'menu-active' : ''; ?>">
                                <i class="fal fa-car"></i>
                                <a href="#"> Drivers</a>
                            </li>
                            <li data-link="<?=URL_ROOT;?>/admin/routes"
                                class="<?=($_SESSION['menu_active']=="routes") ? 'menu-active' : ''; ?>">
                                <i class="fal fa-route"></i>
                                <a href="#"> Routes</a>
                            </li>
                            <li data-link="<?=URL_ROOT;?>/admin/places"
                                class="<?=($_SESSION['menu_active']=="places") ? 'menu-active' : ''; ?>">
                                <i class="fal fa-map-marked-alt"></i>
                                <a href="#"> Places</a>
                            </li>
                            <li data-link="<?=URL_ROOT;?>/admin/logs"
            ...
            <div id="add-post">
                ...
                <div class="search-dash">
                    <div id="search-sort">
                        ...
                        <select name="search" id="searchOptions"
                            style="position: absolute;top: 0;width: 150px;right: 0;">
                ...
                <div>
                    ...
                    <div style="margin-top:5px;">
                        <div
                            style="width: 30px;height: 30px;margin-left: 10px;border-radius: 50%;background: #f3f3f3;background-image: url('<?=URL_ROOT;?>/img/prof.png');background-size: contain;background-repeat: no-repeat;background-position: center;">
